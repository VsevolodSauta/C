...
size_t ucs2decode(ucs2 *dst, size_t dst_size, const utf8 *s)
{
  ...
  if (s) do {
    ...
    if (((0x00 == ((s[0]) & 0x80))))
      v = ((ucs4)(s[0])), s += 1;
    else if (((0xc0 == ((s[0]) & 0xe0))&&((s)[1]&192)==128))
      v = ((ucs4) (((s[0])&31)<<6)|((s[1])&63)), s += 2;
    else if (((0xe0 == ((s[0]) & 0xf0))&& ((s)[1]&192)==128&&((s)[2]&192)==128))
      v = ((ucs4) (((s[0])&15)<<12)|(((s[1])&63)<<6)|((s[2])&63)), s += 3;
    else {
      s++;
      continue;
    }
...
size_t ucs2encode(utf8 *dst, const ucs2 *s, size_t n, const char quote[128])
{
 ...
 d += 1;
    ...
    else if ((0x80u <= (ucs4)(c) && (ucs4)(c) <= 0x7ffu)) {
      ((d)[0]=(((c)>>6)&31)|0xc0, (d)[1]=((c)&63)|128);
      d += 2;
    }
    else {
      ((d)[0]=(((c)>>12)&15)|0xe0, (d)[1]=((c>>6)&63)|128, (d)[2]=((c)&63)|128);
      d += 3;
    }
  }
...
size_t ucs2declen(const utf8 *s)
{
  ...
  do { if (s) while (*s) { utf8 c = *s++; if ((0x00 == ((c) & 0x80))) len++; else if ((0xc0 == ((c) & 0xfc))) { if ((0x80 == ((s[0]) & 0xc0))) len++, s++; else errors++; } else if ((0xc0 == ((c) & 0xe0))) { if ((0x80 == ((s[0]) & 0xc0))) len++, s++; else errors++; } else if ((0xe0 == ((c) & 0xf0))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0))) len++, s++, s++; else errors++; } else if ((0xf0 == ((c) & 0xf8))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0)) && (0x80 == ((s[2]) & 0xc0))) errors++, s++, s++, s++; else errors++; } else if ((0xf8 == ((c) & 0xfc))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0)) && (0x80 == ((s[2]) & 0xc0)) && (0x80 == ((s[3]) & 0xc0))) errors++, s++, s++, s++, s++; else errors++; } else if ((0xfc == ((c) & 0xfe))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0)) && (0x80 == ((s[2]) & 0xc0)) && (0x80 == ((s[3]) & 0xc0)) && (0x80 == ((s[4]) & 0xc0))) errors++, s++, s++, s++, s++, s++; else errors++; } else errors++; } } while(0);
