...
# 12 "List_inline.h" 2
# 75 "List_inline.h"
inline size_t List_size(const List *self)
{
 return self->size;
}

inline void List_ifNeededSizeTo_(List *self, size_t newSize)
{
...
inline void *List_rawAt_(List *self, size_t index)
{
 return self->items[index];
}


inline void *List_at_(const List *self, ssize_t index)
{
...
inline size_t List_indexOf_(List *self, void *item)
{
...
inline int List_contains_(List *self, void *item)
{
...
inline void *List_append_(List *self, void *item)
{
...
inline void List_appendSeq_(List *self, const List *otherList)
{
...
inline void List_compactIfNeeded(List *self)
{
...
inline void List_removeIndex_(List *self, size_t index)
{
 if (index < self->size)
 {
...
inline void List_removeIndex_toIndex_(List *self, size_t index1, size_t index2)
{
 size_t length;
...
inline void List_remove_(List *self, void *item)
{
 size_t index;
...
inline int List_removeFirst_(List *self, void *item)
{
...
inline void List_removeLast_(List *self, void *item)
{
...
inline void List_removeItems_(List *self, List *other)
{
...
inline void List_at_insert_(List *self, size_t index, void *item)
{
 if (index > self->size - 1)
 {
...
inline void List_at_put_(List *self, size_t index, void *item)
{
...
inline void List_swap_with_(List *self, long index1, long index2)
{
...
inline void List_reverseInPlace(List *self)
{
...
inline void List_push_(List *self, void *item)
{
 List_ifNeededSizeTo_(self, self->size + 1);
 self->items[self->size] = item;
 self->size ++;
...
inline void *List_top(const List *self)
{
 if (!self->size)
 {
  return (void *)0;
...
inline int List_removeTrueFor_(List *self, ListCollectCallback* callback)
{
 size_t getIndex = 0;
 size_t putIndex = 0;
...
inline void List_qsort(List *self, ListSortCallback *callback)
{
 qsort(self->items, self->size, sizeof(void *), *callback);
}

inline void List_qsort_r(List *self, void *context, ListSortRCallback *callback)
{
 portable_qsort_r(self->items, self->size, sizeof(void *), context, *callback);
}

inline void *List_bsearch(List *self, const void *key, ListSortCallback *callback)
{
 return bsearch(key, self->items, self->size, sizeof(void *), callback);
}

inline void *List_first(const List *self)
{
 return List_at_(self, 0);
}

inline void *List_last(List *self)
{
...
# 1 "/home/user/Development/Python/C/utils/fake_libc_include/inttypes.h" 1
# 1 "/home/user/Development/Python/C/utils/fake_libc_include/_fake_defines.h" 1
# 2 "/home/user/Development/Python/C/utils/fake_libc_include/inttypes.h" 2
# 12 "Stack.c" 2
...
void Stack_copy_(Stack *self, const Stack *other)
{
 ...
 self->items = (void **)io_freerealloc(self->items, sizeInBytes);
...
void Stack_compact(Stack *self)
{
 ...
 self->items = (void **)io_freerealloc(self->items, oldSize);
}
