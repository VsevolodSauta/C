...
size_t utf8_width(const utf8 *s)
{
  ...
  do { if (s) while (*s) { utf8 c = *s++; if ((0x00 == ((c) & 0x80))) w8++; else if ((0xc0 == ((c) & 0xfc))) { if ((0x80 == ((s[0]) & 0xc0))) w8++, s++; else errors++; } else if ((0xc0 == ((c) & 0xe0))) { if ((0x80 == ((s[0]) & 0xc0))) w16++, s++; else errors++; } else if ((0xe0 == ((c) & 0xf0))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0))) w16++, s++, s++; else errors++; } else if ((0xf0 == ((c) & 0xf8))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0)) && (0x80 == ((s[2]) & 0xc0))) w32++, s++, s++, s++; else errors++; } else if ((0xf8 == ((c) & 0xfc))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0)) && (0x80 == ((s[2]) & 0xc0)) && (0x80 == ((s[3]) & 0xc0))) w32++, s++, s++, s++, s++; else errors++; } else if ((0xfc == ((c) & 0xfe))) { if ((0x80 == ((s[0]) & 0xc0)) && (0x80 == ((s[1]) & 0xc0)) && (0x80 == ((s[2]) & 0xc0)) && (0x80 == ((s[3]) & 0xc0)) && (0x80 == ((s[4]) & 0xc0))) w32++, s++, s++, s++, s++, s++; else errors++; } else errors++; } } while(0);
